...
//_tn - A CUSTOM PRODUCT LOOP FOR OUR FRONT PAGE

/**
 * _tn - IMPORTANT RESOURCES.
 * Post thumbnail sizes | https://wordpress.stackexchange.com/a/167309/98671.
 */

/**
 * _tn - EXAMPLES OF DEPENDINGON THE WC PRODUCT CLASS
 * Using the WC_Product Class is the way to go | https://docs.woocommerce.com/wc-apidocs/class-WC_Product.html.
 */
// $product->get_type();
// $product->get_name();
// $product->get_slug();
...
/**
 * _tn - SECONDARY ACTIONS IF NEEDED
 * https://businessbloomer.com/woocommerce-display-products-table/
 * WooCommerce provides some add_action capabilities | woocommerce\templates\content-product.php.
 */
